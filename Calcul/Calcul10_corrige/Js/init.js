...
if (form_calcul)
{
  ...
  {
    form_calcul.addEventListener('submit', submitCalcul, false);
  } 
  else
  {
    form_calcul.attachEvent('onsubmit', submitCalcul);
  }
  ...
  {
    change_operation.addEventListener('change', verifForm, false);
  } 
  else
  {
    change_operation.attachEvent('onchange', verifForm);
  }
